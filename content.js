...
(async (browser) => {
  import(browser.runtime.getURL('./polyfill/scroll-to.js')).then((module) => {
    const scrollTo = module.default;
    scrollTo();
  });

  import(browser.runtime.getURL('./polyfill/create-link.js')).then((module) => {
    const createLink = module.default;
